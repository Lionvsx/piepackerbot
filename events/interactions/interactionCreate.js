...
module.exports = class InteractionCreate extends BaseEvent {
    ...
    async run(client, interaction) {
        ...
        if (interaction.isButton()) {
            ...
            if (!interaction.guild.members.cache.get(client.user.id).permissions.has(buttonInteraction.config.clientPermissions)) return client.replyError(interaction, `I don't have the required permissions to execute this command : \`${buttonInteraction.config.clientPermissions.toString()}\``)
